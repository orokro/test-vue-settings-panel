...
<template>
	<div class="app-wrapper">
		<div class="header-actions">
			<ThemeSwitcher v-model:theme="activeTheme" :currentTheme="activeTheme" :showSidebar="showSidebarGlobal"
				@update:showSidebar="updateShowSidebar" @update:spec="updateSpec" />
		...
		<div class="app-container" :class="{ 'reactivity-test': isReactivityTest }">
			<VueSettingsPanel :settings="settingsState" :specification="currentSpec" :themeColors="activeTheme"
				@settings-changed="handleSettingsChanged" />
			<VueSettingsPanel v-if="isReactivityTest" :settings="settingsState" :specification="currentSpec"
				:themeColors="activeTheme" @settings-changed="handleSettingsChanged" />
		</div>
	</div>
</template>
