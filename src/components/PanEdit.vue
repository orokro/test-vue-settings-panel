...
<template>
	<div class="pan-edit">
		<div class="knob-container" @mousedown="onMouseDown" :title="`Value: ${value}`">
		...
		<input type="number" :value="value" @input="onInputChange" class="pan-input" :min="opts.min" :max="opts.max" />
	</div>
</template>
